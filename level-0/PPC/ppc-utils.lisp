...
(defppclapfunction walk-static-area ((a arg_y) (f arg_z))
  (let ((fun save0)
    ...
    (cmpwi cr5 subtag ppc32::subtag-bit-vector)
    (cmpwi cr6 subtag ppc32::subtag-complex-double-float-vector)
...
(defppclapfunction walk-static-area ((a arg_y) (f arg_z))
  (let ((fun save0)
    ...
    (cmpri cr6 tag ppc64::subtag-complex-double-float-vector)
    (header-size elements header)
