...
;;; REWRITE to the x8664 donor (x86-symbol.lisp:29) — Matt's tag
...
;;; =====================================================================
;;;
;;; ⚠ The NILSYM mapping IS REQUIRED on arm64 (; an earlier draft of
...
;;; live in w4 and again in ).

;;; REWRITE to the x8664 donor (x86-symbol.lisp:47) — see %function
...
;;; REWRITE to the x8664 donor (x86-symbol.lisp:58) — typecheck the
...
;;; no analog ( family seed; SYMBOL-NAME et al. call these).
;;; =====================================================================
