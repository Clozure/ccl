...
;;; %INT-TO-SFLOAT demand; pin-gate sweep applied — see the
...
;;;; arm64-lapmacros-additions.lisp
...
;;;; ⚠ UPDATED . This block used to say the mask lives in
...
;;;
;;; ⚠ SUPERSEDED : this block used to say the LOGICAL enable mask
...
;;; =====================================================================
;;; FORMERLY PIN-GATED CLUSTER — UN-GATED .
;;;
...
;;; , and it is why SIN.1-24/COS.1-24/TAN.1-24 were red. Nothing in
...
;;; (measured , image e53da35a). Only the LAP helpers are here.
...
;;; FATAL (cold load, no lisp error system): undefined function %DEFVAR
;;; (measured , image e53da35a). %defvar is a level-1 function
