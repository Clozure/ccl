...
;;; =====================================================================
;;; Demand: l1-symhash wall — MAKE-HASH-TABLE's (eq test #'equal)
...
(defarm64lapfunction equal ((x arg_y) (y arg_z))
 ...
 ;; save-lisp-context re-derives fn from nfn ( KEY-fatal class).
  (mov nfn fn)                                       ; ppc:345
 ...
 ;; the CALLER's fn, and 's boot proved it (fn-relative hairy-equal
