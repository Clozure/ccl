...
;;; lifted from arm64-utils.lisp wave-3).
...
;;; constant-ref — ppc:681 ( demand: CONSTANTLY does
...
;;; (#+ppc64-target arm; ppc32 twin ppc:21 skipped). demand:
...
;;; ( demand; promoted from drafts/arm64-utils.lisp:72)
;;; =====================================================================
;;;
...
;;; ( demand; promoted from drafts/arm64-utils.lisp:288 with three
;;; promotion fixes: (1) ppc:376 (:regsave sentinel 0) dropped — his lap
;;; DSL has no :regsave (DECIDE-7, precedent arm64-array.lisp:287);
...
;;; =====================================================================
;;; ( demand; promoted from drafts/arm64-utils.lisp:138 — :regsave
...
;;; =====================================================================
;;; Demand: l1-aprims (revives the pointer defloadvars around
...
;;; standard-instances here, so the demand pulls both.
...
;;; =====================================================================
;;; Demand: frontier — l1-clos-boot toplevels die at
...
;;; =====================================================================
;;; gc — ppc-utils.lisp:507. PROMOTED from the wave-3 draft
...
;;; =====================================================================
;;; %allocate-list — PPC64 line-port of ppc-utils.lisp:602 ().
...
;;; measured size ladder puts the cliff between 50000 and 100000,
