...
;;;; Expect: arm64-boot.image with the canonical arm64 nil
;;;; (arch::target-nil-value); cold-load reaches READ-LOOP.
...
(unless (eql (arch::target-nil-value (backend-target-arch *host-backend*))
             arm64::canonical-nil-value)
  (error "host arch nil is not the canonical arm64 nil"))
