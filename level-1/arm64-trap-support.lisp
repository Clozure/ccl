...
(macrolet ((init-arm64-xtype-table (&rest pairs)
 ...
 ;; : the SCALAR complex floats. The two *-vector entries above were
 ...
 ;; : bare FULLTAGS. arm64-arch.lisp:189-196 states the expected-type
