...
(def-standard-initial-binding *print-miser-width* nil)
(def-standard-initial-binding *print-pprint-dispatch* nil)
(def-standard-initial-binding *print-pretty* nil)
(def-standard-initial-binding *print-radix* nil)
(def-standard-initial-binding *print-readably* t)
...
(def-standard-initial-binding *read-eval* t) 
