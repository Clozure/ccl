...
(defun current-time-in-nanoseconds ()
  "Return the elapsed real time in nanoseconds, from the same source used
  by GET-INTERNAL-REAL-TIME.  Despite the name, the returned value is not
  the time of day.  Usually GET-INTERNAL-REAL-TIME is sufficient."
  (%monotonic-time 1))
