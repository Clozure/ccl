  ...
  (ecase char
    ...
    ((#\F)
     ...
     (with-format-parameters parms ((w nil) (d nil) (k nil) (ovf nil) (pad #\space))
       ...
       (format-require-type k '(or null (integer 0)) "k (third parameter)")
       (format-require-type ovf '(or null character) "ovf (fourth parameter)")
       (format-require-type pad '(or null character) "pad (fifth parameter)"))
     (pop-format-arg))
    ((#\E #\G)
     (format-no-flags colon nil)
     (with-format-parameters parms ((w nil) (d nil) (e nil) (k 1) (ovf nil) (pad #\space) (marker nil))
       (format-require-type w '(or null (integer 0)) "w (first parameter)")
       (format-require-type d '(or null (integer 0)) "d (second parameter)")
       (format-require-type e '(or null (integer 0)) "d (third parameter)")
       (format-require-type k '(or null (integer 0)) "k (fourth parameter)")
       (format-require-type ovf '(or null character) "ovf (fifth parameter)")
       (format-require-type pad '(or null character) "pad (sixth parameter)")
       (format-require-type marker '(or null character) "marker (seventh parameter)"))
     (pop-format-arg))
    ((#\$)
     (with-format-parameters parms ((d 2) (n 1) (w 0) (pad #\space))
