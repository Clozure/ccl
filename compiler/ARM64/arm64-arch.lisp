...
;;; ------------------------------------------------------------------
;;; Subprimitives the linuxarm64 port adds to the table above. This has
;;; to sit AFTER *arm64-target-arch*, because it refreshes the arch
;;; struct's captured table as well as the variable: subprim-name->offset
;;; resolves through the struct, so extending only the variable gives
;;; ".SPRPLACD not found" while the variable plainly holds it.
;;; ------------------------------------------------------------------
;;; SPDX-License-Identifier: Apache-2.0
;;;
