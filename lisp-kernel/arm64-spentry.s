 ...
 *   what make the port able to run at all; the bodies they point at live
 *   below in this file (which absorbed the former spentry-{A..E}.s).
 *
...
/* fixnum 1 and the *INTERRUPT-LEVEL* tlb index (x86-constants64.s:414/867).
   arm64-constants.h defines neither (it has only fixnumshift/fixnummask).
   The cluster sections below re-equate these names with identical values
   (each was once its own translation unit); .set redefinition is legal and
   positional, so the duplicates are benign. */
...
/* Poll for a deferred interrupt (ppc-macros.s check_pending_interrupt;
   clobbers nargs; callers that must preserve nargs save/restore around it). */
...
/* Shared helper macros, formerly one copy per cluster translation unit
   (a .macro redefinition is an assembler error, so these live here alone;
   the shared .set equates, by contrast, may lawfully repeat below). */
...
/* Branch target PRIVATE to the sketch above.  Was C(misc_ref_common) when
   this was its own translation unit; renamed in the single-file merge
   because the vectors-misc cluster below carries the REAL misc_ref_common. */
misc_ref_sketch_common:
        ret
...
/* ===========================================================================
 * (formerly spentry-A-alloc-numbers.s)
 * ===========================================================================
 */
...
/* ===========================================================================
 * (formerly spentry-B-vectors-misc.s)
 * ===========================================================================
 */
...
/* ===========================================================================
 * (formerly spentry-C-bind-catch-throw.s)
 * ===========================================================================
 */
...
/* control-stack lisp_frame build (MARKER frame: \tmp carries the
...
/* ===========================================================================
 * (formerly spentry-D-call-builtins.s)
 * ===========================================================================
 */
